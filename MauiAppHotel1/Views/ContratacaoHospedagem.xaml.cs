...
public partial class ContratacaoHospedagem : ContentPage
{
	...
	public ContratacaoHospedagem()
	{
        ...
        dtpck_checkout.MinimumDate = dtpck_checkin.Date.AddDays(1); //sobre o check out para não ser no passado
    ...
    private async void Button_Clicked_1(object sender, EventArgs e) //avançar
    {
        try
        {
